                    ...
                    <div className="space-y-4">
                        ...
                        <GlassPanel>
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <h2 className="text-lg font-bold text-white">Immediate (Q1 2026)</h2>
                            </div>
                            {(() => {
                    ...
                    <div className="space-y-4">
                        ...
                        <GlassPanel>
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <h2 className="text-lg font-bold text-white">Quarterly (Q2-Q3 2026)</h2>
                            </div>
                            {(() => {
                    ...
                    <div className="space-y-4">
                        ...
                        <GlassPanel>
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <h2 className="text-lg font-bold text-white">Innovation (2027+)</h2>
                            </div>
                            {(() => {
